...
export default function Listing() {
    ...
    return (
        ...
        className='px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg w-full text-center transition duration 150 ease-out'>Contact Landlord</button>
        </div>
        )}
        {contactLandlord && (
            <Contact 
